...
${OBJECTDIR}/_ext/414208620/linenoise.o: ../libs/linenoise/linenoise.c 
	...
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/414208620/linenoise.o ../libs/linenoise/linenoise.c

${OBJECTDIR}/_ext/414208620/utf8.o: ../libs/linenoise/utf8.c 
	${MKDIR} -p ${OBJECTDIR}/_ext/414208620
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/414208620/utf8.o ../libs/linenoise/utf8.c

${OBJECTDIR}/_ext/1200001932/pugixml.o: ../libs/pugixml_1.2/pugixml.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/1200001932
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/1200001932/pugixml.o ../libs/pugixml_1.2/pugixml.cpp
...
${TESTDIR}/_ext/1357304591/editorMachineTestClass.o: ../libs/tests/editorMachineTestClass.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/_ext/1357304591/editorMachineTestClass.o ../libs/tests/editorMachineTestClass.cpp


${TESTDIR}/_ext/1357304591/editorMachineTestRunner.o: ../libs/tests/editorMachineTestRunner.cpp 
	${MKDIR} -p ${TESTDIR}/_ext/1357304591
	${RM} "$@.d"
	$(COMPILE.cc) -g `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/_ext/1357304591/editorMachineTestRunner.o ../libs/tests/editorMachineTestRunner.cpp


${TESTDIR}/_ext/1357304591/newtestclass1.o: ../libs/tests/newtestclass1.cpp 
	${MKDIR} -p ${TESTDIR}/_ext/1357304591
	${RM} "$@.d"
	$(COMPILE.cc) -g -I. `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/_ext/1357304591/newtestclass1.o ../libs/tests/newtestclass1.cpp


${TESTDIR}/_ext/1357304591/newtestrunner1.o: ../libs/tests/newtestrunner1.cpp 
	${MKDIR} -p ${TESTDIR}/_ext/1357304591
	${RM} "$@.d"
	$(COMPILE.cc) -g -I. `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/_ext/1357304591/newtestrunner1.o ../libs/tests/newtestrunner1.cpp


${TESTDIR}/_ext/1357304591/utilsTestClass.o: ../libs/tests/utilsTestClass.cpp 
	${MKDIR} -p ${TESTDIR}/_ext/1357304591
	${RM} "$@.d"
	$(COMPILE.cc) -g -I. `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/_ext/1357304591/utilsTestClass.o ../libs/tests/utilsTestClass.cpp
...
${OBJECTDIR}/_ext/414208620/linenoise_nomain.o: ${OBJECTDIR}/_ext/414208620/linenoise.o ../libs/linenoise/linenoise.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -g -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/414208620/linenoise_nomain.o ../libs/linenoise/linenoise.c;\
	else  \
...
${OBJECTDIR}/_ext/414208620/utf8_nomain.o: ${OBJECTDIR}/_ext/414208620/utf8.o ../libs/linenoise/utf8.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -g -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/414208620/utf8_nomain.o ../libs/linenoise/utf8.c;\
	else  \
...
${OBJECTDIR}/_ext/1200001932/pugixml_nomain.o: ${OBJECTDIR}/_ext/1200001932/pugixml.o ../libs/pugixml_1.2/pugixml.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/1200001932/pugixml_nomain.o ../libs/pugixml_1.2/pugixml.cpp;\
	else  \
...
${OBJECTDIR}/_ext/1472/main_nomain.o: ${OBJECTDIR}/_ext/1472/main.o ../main.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/1472/main_nomain.o ../main.cpp;\
	else  \
